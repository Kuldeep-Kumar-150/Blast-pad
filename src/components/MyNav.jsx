            ...
            <div className="container mx-auto px-3">
                <div className="py-7 flex items-center justify-between">
                    <div className="flex items-center cursor-pointer">
                        ...
                        <a className='text-white pl-[10px] ff_inter text-2xl font-medium' href="#">BlastPad.io</a>
                    </div>
                    <ul className={nav == true ? "text-white gap-[20px] bg_blue_linear xl:hidden fixed flex flex-col ease-in-out duration-700 z-50 items-center justify-center top-0 left-0 w-full h-[100vh]" : "bg_blue_linear text-white gap-[20px] xl:hidden fixed flex flex-col ease-in-out duration-700 left-[-100%] w-[50%] h-0 z-50 items-center justify-center top-[-50%]"}>
                        <li onClick={() => setNav(false)}><a className='text-[14px] font-medium ff_raleway text-[#B1B2BE]' href="#">Home</a></li>
                        <li onClick={() => setNav(false)}><a className='text-[14px] font-medium ff_raleway text-[#B1B2BE]' href="#">About Us</a></li>
                        <li onClick={() => setNav(false)}><a className='text-[14px] font-medium ff_raleway text-[#B1B2BE]' href="#">Token AirDrop</a></li>
                        <li onClick={() => setNav(false)}><a className='text-[14px] font-medium ff_raleway text-[#B1B2BE]' href="#">Token Staking</a></li>
                        <li onClick={() => setNav(false)}><a className='text-[14px] font-medium ff_raleway text-[#B1B2BE]' href="#">Create a Token</a></li>
                        <li onClick={() => setModal(true)} onClickCapture={() => setNav(false)}> <button className='text-white text-lg font-semibold ff_raleway px-[20px] py-[13px] bg-[#071436] rounded-full border border-[#3A486C] md:hidden'>Get into Touch</button></li>
                        <li onClick={() => setNav(false)} className="flex items-center px-[20px] py-[13px] cursor-pointer rounded-full bg_blue_linear md:hidden">
                            <img src={walletImg} alt="walletImg" />
                            <button className='text-white text-lg font-semibold ff_raleway ml-[10px]'> Connect Wallet</button>
                        </li>
                    </ul>
                    <ul className='text-white gap-[20px] hidden xl:flex'>
                        <li><a className='text-[14px] font-medium ff_raleway text-[#B1B2BE]' href="#">Home</a></li>
                        <li><a className='text-[14px] font-medium ff_raleway text-[#B1B2BE]' href="#">About Us</a></li>
                        <li><a className='text-[14px] font-medium ff_raleway text-[#B1B2BE]' href="#">Token AirDrop</a></li>
                        <li><a className='text-[14px] font-medium ff_raleway text-[#B1B2BE]' href="#">Token Staking</a></li>
                        <li><a className='text-[14px] font-medium ff_raleway text-[#B1B2BE]' href="#">Create a Token</a></li>
                    </ul>
                    <div className="flex items-center">
                        <div className='flex items-center'>
                            <button onClick={() => setModal(true)} className='text-white hidden md:flex text-lg font-semibold ff_raleway px-[20px] py-[13px] bg-[#071436] rounded-full border border-[#3A486C] mr-5'>Get into Touch</button>
                            <div className="items-center hidden md:flex px-[20px] py-[13px] cursor-pointer rounded-full bg_blue_linear">
                                <img src={walletImg} alt="walletImg" />
                                <button className='text-white text-lg font-semibold ff_raleway ml-[10px]'> Connect Wallet</button>
                            </div>
                        </div>
                ...
                {/*******--MODAL--*******/}
                <div className="">
                    <div className={modal === true ? "scale-100 ease-in-out duration-500 z-50 absolute top-30 sm:top-[50%] left-[50%] translate-x-[-50%] sm:translate-y-[-50%] w-[95%] xl:w-[970px]" : "w-[95%] xl:w-[970px] scale-0 ease-in-out duration-500 z-50 rounded-[15px] absolute top-30 sm:top-[50%] left-[50%] translate-x-[-50%] sm:translate-y-[-50%]"}>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 py-3 lg:pt-20 px-3 lg:px-10 lg:pb-10">
                                <div className='flex flex-col justify-between'>
                                    <div>
                                        <div className="flex items-center">
                                            ...
                                            <div className='ms-4'>
                                                <p className='text-base font-bold ff_raleway text-white'>Bitcoin</p>
                                                <p className='text-[14px] font-normal ff_raleway text-white text-opacity-70'>$BTC</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center mt-6">
                                            <img className='w-[50px]' src={modalRocket} alt="modalRocket" />
                                            <div className='ms-4'>
                                                <p className='text-[17px] font-medium ff_inter text-white'>BlastPad.io</p>
                                                <div className="lg:flex">
                                                    <p className='text-[12px] font-normal ff_raleway text-[#CACED5]'>www.Blastpad.com</p>
                                                    <p className='text-[12px] font-normal ff_raleway text-[#CACED5] lg:ms-[50px]'>xyz@example.com</p>
                                                </div>
                                            </div>
                                        </div>
                                        <p className='text-base font-bold ff_raleway text-white mt-[18px]'>Project Information</p>
                                        <p className='text-white text-base font-normal  ff_raleway #CACED5 mt-4'>Lorem ipsum dolor sit amet consectetur. Odio hac malesuada semper turpis leo pellentesque ac. In porttitor donec neque varius eget pretium fusce magna iaculis. Eu magnis aliquam vitae fermentum orci ultrices. Gravida a orci auctor varius lacus suspendisse pulvinar scelerisque. Elementum sed egestas quis consectetur non arcu felis pharetra ultrices. Feugiat euismod gravida odio pretium netus..felis pharetra ultrices. Feugiat euismod gravida odio pretium netus..</p>
                                    </div>
                                ...
                                <div className='lg:ps-10 mt-6 lg:mt-0'>
                                    <form className='flex flex-col justify-between'>
                                        <div>
                                            <h3 className='text-2xl font-semibold ff_raleway text-white mb-6'>Have a Query?</h3>
                                            <label className='text-base font-normal ff_raleway text-white text-opacity-80' htmlFor="name">Name <br />
                                                <input className='w-full mt-[10px] text-base font-normal ff_raleway text-[#CBCFDA] outline-none py-[18px] px-4 rounded bg-[#505F83] border-[1.27px] border-[#626F8F]' id='name' placeholder='Enter name' type="text" />
                                            </label>
                                            <label className='text-base block mt-4 font-normal ff_raleway text-white text-opacity-80' htmlFor="email">Email Address <br />
                                                <input className='w-full mt-[10px] text-base font-normal ff_raleway text-[#CBCFDA] outline-none py-[18px] px-4 rounded bg-[#505F83] border-[1.27px] border-[#626F8F]' id='email' placeholder='nickraja@example.com' type="text" />
                                            </label>
                                            <label className='text-base block mt-4 font-normal ff_raleway text-white text-opacity-80' htmlFor="message">Message
                                                <textarea className='w-full mt-[10px] resize-none hide_scroll_bar min-h-[106px] outline-none p-[18px] bg-[#505F83]  text-base font-normal ff_raleway rounded border-[1.27px] border-[#626F8F] text-[#CBCFDA]' id="message" placeholder='Lorem ipsum dolor sit amet consectetur. Purus a vestibulum nisl eget mattis leo. Turpis ut aenean ante ut consectetur iaculis leo. Malesuada.'></textarea>
                                            </label>
                                        </div>
                                        <div>
                                            <a onClick={() => setModal(false)} className='bg_blue_linear py-[10px] px-[36px] inline-block rounded-full text-[18px] font-semibold text-white ff_raleway mt-[20px]' href="#">Sumit</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
