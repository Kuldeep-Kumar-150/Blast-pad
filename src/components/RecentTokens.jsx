      ...
      <div className="container mx-auto px-3 relative">
        ...
        <div className="relative">
          <button
            ...
            className="h-12 ease-in-out duration-300 hover:bg-[#4478F9] flex max-[1260px]:hidden absolute w-[52px] 2xl:-left-24 -left-14  top-[50%] translate-y-[-50%] bg-[#0B0A34] rounded-[6px] border border-[#2F2D50]  items-center justify-center"
          >
            <svg
              width="14"
              height="24"
                ...
                <div className="px-3">
                  <div className="px-[19px] py-6 border border-[#242246] card_shadow rounded-2xl">
                    <div className="flex items-center">
                      ...
                      <div className="ms-4">
                        <p className="text-white text-[20px] font-bold ff_raleway">
                          {rslider.headingName}
                        </p>
                        <p className="text-white ff_raleway font-normal text-sm text-opacity-70">
                          {rslider.btc}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center justify-between mt-8">
                      <p className="text-base font-normal ff_raleway text-opacity-90 text-white">
                        {rslider.total}
                      </p>
                    ...
                    <div className="flex items-center justify-between mt-4">
                      <p className="text-base font-medium ff_raleway text-white text-opacity-80 underline">
                        {rslider.stakeToken}
                      </p>
                      <p className="text-base font-medium ff_raleway text-white text-opacity-80 underline">
                        {rslider.claimDrop}
                    ...
                    <button
                      ...
                      className="bg-gradient-to-r from-[#070380] to-[#4478F9] ease-in-out duration-300 hover:scale-95 w-full py-3 text-center rounded-full border border-[#2D2B95] text-white ff_raleway font-medium text-base mt-8"
                    >
                      {rslider.btn}
                    </button>
                  </div>
