    ...
    <div className="py-16 ">
      <div className="container mx-auto px-3 relative">
        <button
          ...
          className=" h-12 absolute hidden lg:flex  w-[52px] 2xl:-left-24 -left-14  top-64 bg-[#0B0A34] rounded-[6px] border border-[#2F2D50]  items-center justify-center"
        >
          <svg
            width="14"
            height="24"
        ...
        <button
          ...
          className=" h-12 absolute hidden lg:flex 2xl:-right-24 -right-14  top-64 w-[52px] bg-[#0B0A34] rounded-[6px] border border-[#2F2D50]  items-center justify-center"
        >
          <svg
            width="14"
            height="24"
