...
const Header = () => {
  return (
    <header className="flex flex-col items-center justify-center flex-grow relative">
      ...
      <div className="container mx-auto px-3 lg:my-10 xl:my-0">
        <img
          className="absolute right-0 top-[42%] w-[163px] hidden sm:flex"
          src={earthImg}
          alt="earthImg"
        />
        <div className="flex-wrap lg:grid grid-cols-1 lg:grid-cols-2 flex-col-reverse flex lg:my-10 lg:py-10 xl:py-0 xl:my-0">
          <div className="z-20 text-center lg:text-start">
            ...
            <h1
              className="text-[39px] sm:text-[70px] md:text-[60px] xl:text-[70px] leading-[45px] lg:leading-[75px] xl:leading-[85px] 
             sm:leading-[90px] font-bold ff_raleway text-white  mt-3 sm:mt-[22px]"
            >
              The fastest way to launch your new project
            </h1>
            <a
              href="#"
              className="text-lg font-semibold ff_raleway text-white py-[18px] px-9 bg_blue_linear rounded-full inline-block mt-10 md:mt-[66px]"
            >
              Learn more
            </a>
          </div>
          <div className="relative mt-20">
            ...
            <img
              className="absolute top-[-30px] left-36"
              src={smallRocket}
              alt="smallRocket"
            />
