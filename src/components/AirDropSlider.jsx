                                    ...
                                    <div className="border rounded-2xl border-[#222851] bg-[#0A103D] p-5">
                                        <div className="flex items-center">
                                            ...
                                            <div className='ms-4'>
                                                ...
                                                <p className='text-[14px] font-normal ff_raleway text-[#B5B7C4]'>{m.btc}</p>
                                            </div>
                                        </div>
                                        <div className="flex justify-between mt-6">
                                            <p className='text-base font-normal ff_raleway text-[#E6E7EB]'>{m.totalSupply}</p>
                                            <p className='text-base font-semibold ff_raleway text-white font_feature'>{m.supplValue}</p>
                                        </div>
                                        <div className="flex justify-between mt-4">
                                            <p className='text-base font-normal ff_raleway text-[#E6E7EB]'>{m.priceText}</p>
