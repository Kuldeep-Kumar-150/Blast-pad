      ...
      <div className="container mx-auto px-3 relative">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 items-center">
          ...
          <div className="blackchain_text relative text-center lg:text-start">
            <h2 className="text-white text-[30px] mt-5 sm:mt-10 sm:text-[40px] font-bold ff_raleway leading-[46px]">
              Building On The Proton Blockchain
            </h2>
            <p className="text-white text-base font-normal ff_raleway text-opacity-70 mt-4">
