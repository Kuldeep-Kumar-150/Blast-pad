...
function BlaspadBonesSection() {
  return (
    <section className="bg_blaspad_img bg-no-repeat bg-cover xl:pt-[188px] lg:pt-[100px] pt-[50px]">
      {" "}
      ...
      <div className="container mx-auto px-3">
        <div className="md:flex-row  md:justify-between flex-col items-center flex ">
          ...
          <div className="lg:w-5/12 md:w-6/12  lg:pt-12 text-center md:text-start">
            <h2 className="mb-0 text-white ff_raleway  font-bold lg:text-[40px] md:text-[30px] sm:text-[30px] text-[25px]">
              BlastPad Bonus Pool
            </h2>
            <p className=" ff_raleway font-normal text-base text-white lg:pt-2">
        ...
        <div className="pt-8">
          <h2 className=" ff_raleway  font-bold md:text-[40px] sm:text-[30px] text-[25px]   text-white text-center md;leading-[46px]">
            Stake your Blastpad tokens for{" "}
            <span className="md:block">Bonus Pool Rewards</span>
          </h2>
          <div className="md:flex  justify-between">
            <div className=" md:w-5/12  ">
              <h3 className=" ff_raleway font-semibold text-2xl text-white pt-4 md:pt-10 ">
                {" "}
                We can have 3 levels of staking
              </h3>
              <p className=" ff_raleway font-normal text-base text-white pt-4 md:max-w-[396px]">
                Lorem ipsum dolor sit amet consectetur. Nisi enim tellus quisque
                euismod feugiat sed vestibulum fermentum tempor.
              </p>
              <div className="flex">
                <div className=" bg-[#030739] w-[130px] h-[90px] lg:h-[114px] items-center flex justify-center mt-6">
                  <h2 className=" ff_raleway font-semibold text-[25px] lg:text-[40px] text-white">
                    1m
                  </h2>
                </div>
                <div className=" bg-[#030739] w-[130px] h-[90px] lg:h-[114px] items-center flex justify-center mt-6 ms-6">
                  <h2 className=" ff_raleway font-semibold text-[25px] lg-text-[40px] text-white">
                    5m
                  </h2>
                </div>
                <div className=" bg-[#030739] w-[130px] lg:h-[114px] h-[90px] items-center flex justify-center mt-6 ms-6">
                  <h2 className=" ff_raleway font-semibold text-[25px] lg:text-[40px] text-white">
                    10m
                  </h2>
                </div>
            ...
            <div className="md:w-6/12 flex items-end pt-8">
              <div className="w-4/12 pr-3">
                <div className="flex items-end">
                  ...
                  <div className="ml-4 ">
                    <img
                      className=" h-[124px] -translate-y-4"
                      src={bones_img1}
                      alt="bones_img1"
                    />
                  </div>
              ...
              <div className="w-4/12 pr-3">
                <div className="flex items-end">
                  ...
                  <div className="ml-4 ">
                    <img
                      className=" h-[144px] -translate-y-4"
                      src={bones_img1}
                      alt="bones_img1"
                    />
                  </div>
              ...
              <div className="w-4/12 ">
                <div className="flex items-end">
                  ...
                  <div className="ml-4 ">
                    <img
                      className=" h-[180px] -translate-y-4"
                      src={bones_img1}
                      alt="bones_img1"
                    />
                  </div>
